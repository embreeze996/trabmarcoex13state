...
public class SerieEstadoCancelada extends SerieEstado {

    private SerieEstadoCancelada() {};
    private static SerieEstadoCancelada instance = new SerieEstadoCancelada();
    public static SerieEstadoCancelada getInstance() {
        return instance;
    }
